...
=======
#housepriceindexes
house_price<-read_excel("D:/r git projects/ox-R/final essay/UKHLS n BHPS stata/UKDA-6614-stata/stata/stata13_se/ukhousepriceindexmonthlypricestatistics.xlsx",sheet ="2")
house_price<-as.data.frame(house_price)
house_price<-house_price[2:174,]
house_price<-house_price %>%row_to_names(row_number = 1)
house_price$`Time period`<-toupper(house_price$`Time period`)
...
a_indresp<-a_indresp%>%dplyr::select(pidp, a_hidp, a_mastat_dv,
         ...
         a_mastat_dv, a_racel_dv,a_fimnnet_dv,a_nchild_dv,a_urban_dv,a_gor_dv,a_jbstat,a_sf1,a_susp,a_strata,a_psu)
=======
         a_mastat_dv, a_racel_dv,a_fimnnet_dv,a_nchild_dv,a_urban_dv,a_gor_dv,a_jbstat,a_sf1,a_susp,a_strata,a_psu,a_month)
...
b_indresp<-b_indresp%>%dplyr::select(pidp, b_hidp, b_mastat_dv,
         ...
         b_mastat_dv, b_racel_dv,b_fimnnet_dv,b_nchild_dv,b_urban_dv,b_gor_dv,b_jbstat,b_sf1,b_scsf1,b_susp,b_strata,b_psu)
=======
         b_mastat_dv, b_racel_dv,b_fimnnet_dv,b_nchild_dv,b_urban_dv,b_gor_dv,b_jbstat,b_sf1,b_scsf1,b_susp,b_strata,b_psu,b_month)
...
c_indresp<-c_indresp%>%dplyr::select(pidp, c_hidp, c_mastat_dv,
         ...
         c_mastat_dv, c_racel_dv,c_fimnnet_dv,c_nchild_dv,c_urban_dv,c_gor_dv,c_jbstat,c_sf1,c_scsf1,c_susp,c_strata,c_psu)
=======
         c_mastat_dv, c_racel_dv,c_fimnnet_dv,c_nchild_dv,c_urban_dv,c_gor_dv,c_jbstat,c_sf1,c_scsf1,c_susp,c_strata,c_psu,c_month)
...
d_indresp<-d_indresp%>%dplyr::select(pidp, d_hidp, d_mastat_dv,
         ...
         d_mastat_dv, d_racel_dv,d_fimnnet_dv,d_nchild_dv,d_urban_dv,d_gor_dv,d_jbstat,d_sf1,d_scsf1,d_susp,d_strata,d_psu)
=======
         d_mastat_dv, d_racel_dv,d_fimnnet_dv,d_nchild_dv,d_urban_dv,d_gor_dv,d_jbstat,d_sf1,d_scsf1,d_susp,d_strata,d_psu,d_month)
...
e_indresp<-e_indresp%>%dplyr::select(pidp, e_hidp, e_mastat_dv,
         ...
         e_mastat_dv, e_racel_dv,e_fimnnet_dv,e_nchild_dv,e_urban_dv,e_gor_dv,e_jbstat,e_sf1,e_scsf1,e_susp,e_strata,e_psu)
=======
         e_mastat_dv, e_racel_dv,e_fimnnet_dv,e_nchild_dv,e_urban_dv,e_gor_dv,e_jbstat,e_sf1,e_scsf1,e_susp,e_strata,e_psu,e_month)
...
f_indresp<-f_indresp%>%dplyr::select(pidp, f_hidp, f_mastat_dv,
         ...
         f_mastat_dv, f_racel_dv,f_fimnnet_dv,f_nchild_dv,f_urban_dv,f_gor_dv,f_jbstat,f_sf1,f_scsf1,f_susp,f_strata,f_psu,f_indscub_lw)
=======
         f_mastat_dv, f_racel_dv,f_fimnnet_dv,f_nchild_dv,f_urban_dv,f_gor_dv,f_jbstat,f_sf1,f_scsf1,f_susp,f_strata,f_psu,f_indscub_lw,f_month)
...
g_indresp<-g_indresp%>%dplyr::select(pidp, g_hidp, g_mastat_dv,
         ...
         g_mastat_dv, g_racel_dv,g_fimnnet_dv,g_nchild_dv,g_urban_dv,g_gor_dv,g_jbstat,g_sf1,g_scsf1,g_susp,g_indscui_lw,g_strata,g_psu)
=======
         g_mastat_dv, g_racel_dv,g_fimnnet_dv,g_nchild_dv,g_urban_dv,g_gor_dv,g_jbstat,g_sf1,g_scsf1,g_susp,g_indscui_lw,g_strata,g_psu,g_month)
...
g_hhresp<-read_dta(file=paste0(inpath, "ukhls/g_hhresp.dta"))  %>%
 dplyr::select(g_hidp,g_tenure_dv,g_ivfho)
...
f_hhsamp<-read_dta(file=paste0(inpath, "ukhls/f_hhsamp.dta"))  %>%
 dplyr::select(f_hidp,f_emboost,f_iembelig)
...
h_indresp<-h_indresp%>%dplyr::select(pidp, h_hidp, h_mastat_dv,
         ...
         h_mastat_dv, h_racel_dv,h_fimnnet_dv,h_nchild_dv,h_urban_dv,h_gor_dv,h_jbstat,h_sf1,h_scsf1,h_susp,h_strata,h_psu)
=======
         h_mastat_dv, h_racel_dv,h_fimnnet_dv,h_nchild_dv,h_urban_dv,h_gor_dv,h_jbstat,h_sf1,h_scsf1,h_susp,h_strata,h_psu,h_month)
...
i_indresp<-i_indresp%>%dplyr::select(pidp, i_hidp, i_mastat_dv,
         ...
         i_mastat_dv, i_racel_dv,i_fimnnet_dv,i_nchild_dv,i_urban_dv,i_gor_dv,i_jbstat,i_sf1,i_scsf1,i_susp,i_strata,i_psu,i_indscui_lw)
=======
         i_mastat_dv, i_racel_dv,i_fimnnet_dv,i_nchild_dv,i_urban_dv,i_gor_dv,i_jbstat,i_sf1,i_scsf1,i_susp,i_strata,i_psu,i_indscui_lw,i_month)
...
j_indresp<-j_indresp%>%dplyr::select(pidp, j_hidp, j_mastat_dv,
         ...
         j_mastat_dv, j_racel_dv,j_fimnnet_dv,j_nchild_dv,j_urban_dv,j_gor_dv,j_jbstat,j_sf1,j_scsf1,j_susp,j_strata,j_psu)
=======
         j_mastat_dv, j_racel_dv,j_fimnnet_dv,j_nchild_dv,j_urban_dv,j_gor_dv,j_jbstat,j_sf1,j_scsf1,j_susp,j_strata,j_psu,j_month)
...
k_indresp<-k_indresp%>%dplyr::select(pidp, k_hidp, k_mastat_dv,
         ...
         k_mastat_dv, k_racel_dv,k_fimnnet_dv,k_nchild_dv,k_urban_dv,k_gor_dv,k_jbstat,k_sf1,k_scsf1,k_susp,k_strata,k_psu)
=======
         k_mastat_dv, k_racel_dv,k_fimnnet_dv,k_nchild_dv,k_urban_dv,k_gor_dv,k_jbstat,k_sf1,k_scsf1,k_susp,k_strata,k_psu,k_month)
...
l_indresp<-l_indresp%>%dplyr::select(pidp, l_hidp, l_mastat_dv,
         ...
         l_mastat_dv, l_racel_dv,l_fimnnet_dv,l_nchild_dv,l_urban_dv,l_gor_dv,l_jbstat,l_sf1,l_scsf1,l_strata,l_psu)
=======
         l_mastat_dv, l_racel_dv,l_fimnnet_dv,l_nchild_dv,l_urban_dv,l_gor_dv,l_jbstat,l_sf1,l_scsf1,l_strata,l_psu,l_month)
...
m_indresp<-m_indresp%>%dplyr::select(pidp, m_hidp, m_mastat_dv,
         ...
         m_mastat_dv, m_racel_dv,m_fimnnet_dv,m_nchild_dv,m_urban_dv,m_gor_dv,m_jbstat,m_sf1,m_scsf1,m_strata,m_psu,m_indscui_lw)
=======
         m_mastat_dv, m_racel_dv,m_fimnnet_dv,m_nchild_dv,m_urban_dv,m_gor_dv,m_jbstat,m_sf1,m_scsf1,m_strata,m_psu,m_indscui_lw,m_month)
...
n_indresp<-n_indresp%>%dplyr::select(pidp, n_hidp, n_mastat_dv,
         ...
         n_mastat_dv, n_racel_dv,n_fimnnet_dv,n_nchild_dv,n_urban_dv,n_gor_dv,n_jbstat,n_sf1,n_scsf1,n_indscui_lw,n_strata,n_psu)
=======
         n_mastat_dv, n_racel_dv,n_fimnnet_dv,n_nchild_dv,n_urban_dv,n_gor_dv,n_jbstat,n_sf1,n_scsf1,n_indscui_lw,n_strata,n_psu,n_month)
...
```{r}
a_indresp$a_month<-names(attr(a_indresp$a_month,"labels")[match(a_indresp$a_month,attr(a_indresp$a_month,"labels"))])
a_indresp$a_month<-toupper(a_indresp$a_month)
a_indresp$a_month<-gsub("YR1", "2009", a_indresp$a_month)
a_indresp$a_month<-gsub("YR2", "2010", a_indresp$a_month)
  
b_indresp$b_month<-names(attr(b_indresp$b_month,"labels")[match(b_indresp$b_month,attr(b_indresp$b_month,"labels"))])
b_indresp$b_month<-toupper(b_indresp$b_month)
b_indresp$b_month<-gsub("YR1", "2010", b_indresp$b_month)
b_indresp$b_month<-gsub("YR2", "2011", b_indresp$b_month)

c_indresp$c_month<-names(attr(c_indresp$c_month,"labels")[match(c_indresp$c_month,attr(c_indresp$c_month,"labels"))])
c_indresp$c_month<-toupper(c_indresp$c_month)
c_indresp$c_month<-gsub("YR1", "2011", c_indresp$c_month)
c_indresp$c_month<-gsub("YR2", "2012", c_indresp$c_month)

d_indresp$d_month<-names(attr(d_indresp$d_month,"labels")[match(d_indresp$d_month,attr(d_indresp$d_month,"labels"))])
d_indresp$d_month<-toupper(d_indresp$d_month)
d_indresp$d_month<-gsub("YR1", "2012", d_indresp$d_month)
d_indresp$d_month<-gsub("YR2", "2013", d_indresp$d_month)

e_indresp$e_month<-names(attr(e_indresp$e_month,"labels")[match(e_indresp$e_month,attr(e_indresp$e_month,"labels"))])
e_indresp$e_month<-toupper(e_indresp$e_month)
e_indresp$e_month<-gsub("YR1", "2013", e_indresp$e_month)
e_indresp$e_month<-gsub("YR2", "2014", e_indresp$e_month)

f_indresp$f_month<-names(attr(f_indresp$f_month,"labels")[match(f_indresp$f_month,attr(f_indresp$f_month,"labels"))])
f_indresp$f_month<-toupper(f_indresp$f_month)
f_indresp$f_month<-gsub("YR1", "2014", f_indresp$f_month)
f_indresp$f_month<-gsub("YR2", "2015", f_indresp$f_month)

g_indresp$g_month<-names(attr(g_indresp$g_month,"labels")[match(g_indresp$g_month,attr(g_indresp$g_month,"labels"))])
g_indresp$g_month<-toupper(g_indresp$g_month)
g_indresp$g_month<-gsub("YR1", "2015", g_indresp$g_month)
g_indresp$g_month<-gsub("YR2", "2016", g_indresp$g_month)

h_indresp$h_month<-names(attr(h_indresp$h_month,"labels")[match(h_indresp$h_month,attr(h_indresp$h_month,"labels"))])
h_indresp$h_month<-toupper(h_indresp$h_month)
h_indresp$h_month<-gsub("YR1", "2016", h_indresp$h_month)
h_indresp$h_month<-gsub("YR2", "2017", h_indresp$h_month)

i_indresp$i_month<-names(attr(i_indresp$i_month,"labels")[match(i_indresp$i_month,attr(i_indresp$i_month,"labels"))])
i_indresp$i_month<-toupper(i_indresp$i_month)
i_indresp$i_month<-gsub("YR1", "2017", i_indresp$i_month)
i_indresp$i_month<-gsub("YR2", "2018", i_indresp$i_month)

j_indresp$j_month<-names(attr(j_indresp$j_month,"labels")[match(j_indresp$j_month,attr(j_indresp$j_month,"labels"))])
j_indresp$j_month<-toupper(j_indresp$j_month)
j_indresp$j_month<-gsub("YR1", "2018", j_indresp$j_month)
j_indresp$j_month<-gsub("YR2", "2019", j_indresp$j_month)

k_indresp$k_month<-names(attr(k_indresp$k_month,"labels")[match(k_indresp$k_month,attr(k_indresp$k_month,"labels"))])
k_indresp$k_month<-toupper(k_indresp$k_month)
k_indresp$k_month<-gsub("YR1", "2019", k_indresp$k_month)
k_indresp$k_month<-gsub("YR2", "2020", k_indresp$k_month)

l_indresp$l_month<-names(attr(l_indresp$l_month,"labels")[match(l_indresp$l_month,attr(l_indresp$l_month,"labels"))])
l_indresp$l_month<-toupper(l_indresp$l_month)
l_indresp$l_month<-gsub("YR1", "2020", l_indresp$l_month)
l_indresp$l_month<-gsub("YR2", "2021", l_indresp$l_month)

m_indresp$m_month<-names(attr(m_indresp$m_month,"labels")[match(m_indresp$m_month,attr(m_indresp$m_month,"labels"))])
m_indresp$m_month<-toupper(m_indresp$m_month)
m_indresp$m_month<-gsub("YR1", "2021", m_indresp$m_month)
m_indresp$m_month<-gsub("YR2", "2022", m_indresp$m_month)

n_indresp$n_month<-names(attr(n_indresp$n_month,"labels")[match(n_indresp$n_month,attr(n_indresp$n_month,"labels"))])
n_indresp$n_month<-toupper(n_indresp$n_month)
n_indresp$n_month<-gsub("YR1", "2022", n_indresp$n_month)
n_indresp$n_month<-gsub("YR2", "2023", n_indresp$n_month)
...
b_indresp<-b_indresp%>%dplyr::select(pidp, b_hidp, b_mastat_dv,
         ...
         b_mastat_dv, b_racel_dv,b_fimnnet_dv,b_nchild_dv,b_urban_dv,b_gor_dv,b_jbstat,b_sf1,b_susp,b_strata,b_psu)
=======
         b_mastat_dv, b_racel_dv,b_fimnnet_dv,b_nchild_dv,b_urban_dv,b_gor_dv,b_jbstat,b_sf1,b_susp,b_strata,b_psu,b_month)
...
c_indresp<-c_indresp%>%dplyr::select(pidp, c_hidp, c_mastat_dv,
         ...
         c_mastat_dv, c_racel_dv,c_fimnnet_dv,c_nchild_dv,c_urban_dv,c_gor_dv,c_jbstat,c_sf1,c_susp,c_strata,c_psu)
=======
         c_mastat_dv, c_racel_dv,c_fimnnet_dv,c_nchild_dv,c_urban_dv,c_gor_dv,c_jbstat,c_sf1,c_susp,c_strata,c_psu,c_month)
...
g_indresp<-g_indresp%>%dplyr::select(pidp, g_hidp, g_mastat_dv,
         ...
         g_mastat_dv, g_racel_dv,g_fimnnet_dv,g_nchild_dv,g_urban_dv,g_gor_dv,g_jbstat,g_sf1,g_susp,g_strata,g_psu,g_indscui_lw)
=======
         g_mastat_dv, g_racel_dv,g_fimnnet_dv,g_nchild_dv,g_urban_dv,g_gor_dv,g_jbstat,g_sf1,g_susp,g_strata,g_psu,g_indscui_lw,g_month)
...
i_indresp<-i_indresp%>%dplyr::select(pidp, i_hidp, i_mastat_dv,
         ...
         i_mastat_dv, i_racel_dv,i_fimnnet_dv,i_nchild_dv,i_urban_dv,i_gor_dv,i_jbstat,i_sf1,i_scsf1,i_susp,i_strata,i_psu)
=======
         i_mastat_dv, i_racel_dv,i_fimnnet_dv,i_nchild_dv,i_urban_dv,i_gor_dv,i_jbstat,i_sf1,i_scsf1,i_susp,i_strata,i_psu,i_month)
...
indrespa<-rbind.fill(a_indrespp,b_indrespp,c_indrespp,d_indrespp,e_indrespp,f_indrespp,g_indrespp,h_indrespp,i_indrespp)
indrespa<-indrespa[which(indrespa$age_dv%in%c(16:30)),]

indrespb<-rbind.fill(j_indrespp,k_indrespp,l_indrespp,m_indrespp)
...
indrespa$wave[indrespa$from_wave_g==1]<-7
indrespa$wave[indrespa$from_wave_h==1]<-8
indrespa$wave[indrespa$from_wave_i==1]<-9

indrespa$wave<-factor(indrespa$wave,levels=c(1,2,3,4,5,6,7,8,9),labels=c("wave 1","wave 2","wave 3","wave 4","wave 5",'wave 6','wave 7','wave 8','wave 9'))
...
indrespb$wave<-factor(indrespb$wave,levels=c(10,11,12,13),labels=c("wave 10","wave 11","wave 12",'wave 13'))
...
indrespa<-indrespa%>%group_by(pidp)%>%tidyr::fill(hhinterview,.direction="updown")
indrespa<-indrespa%>%mutate(emboost=coalesce(im_emboost,ip_emboost))
indrespa<-indrespa%>%group_by(pidp)%>%tidyr::fill(emboost,.direction="updown")

indrespb<-indrespb%>%mutate(hhinterview=coalesce(im_ivfho,ip_ivfho))
indrespb<-indrespb%>%group_by(pidp)%>%tidyr::fill(hhinterview,.direction="updown")
indrespb<-indrespb%>%mutate(emboost=coalesce(im_emboost,ip_emboost))
indrespb<-indrespb%>%group_by(pidp)%>%tidyr::fill(emboost,.direction="updown")

indresp<-indresp%>%mutate(hhinterview=coalesce(im_ivfho,ip_ivfho))
indresp<-indresp%>%group_by(pidp)%>%tidyr::fill(hhinterview,.direction="updown")
indresp<-indresp%>%mutate(emboost=coalesce(im_emboost,ip_emboost))
indresp<-indresp%>%group_by(pidp)%>%tidyr::fill(emboost,.direction="updown")
indresp<-indresp%>%mutate(iemb=coalesce(im_iembelig,ip_iembelig))
indresp<-indresp%>%group_by(pidp)%>%tidyr::fill(iemb,.direction="updown")

```

```{r}
#attach the weightings


#indresp<-indresp%>%group_by(pidp)%>%tidyr::fill(indscui_lw,.direction="updown")
#indresp$indscui_lw[indresp$indscui_lw<0]<-NA
#indresp<-indresp[which(!is.na(indresp$indscui_lw)),]

#indrespa<-indrespa%>%group_by(pidp)%>%tidyr::fill(indscub_lw,.direction="updown")
#indrespa$indscub_lw[indrespa$indscub_lw<0]<-NA
#indrespa<-indrespa[which(!is.na(indrespa$indscub_lw)),]

#indrespb<-indrespb%>%group_by(pidp)%>%tidyr::fill(indscui_lw,.direction="updown")
#indrespb$indscui_lw[indrespb$indscui_lw<0]<-NA
#indrespb<-indrespb[which(!is.na(indrespb$indscui_lw)),]
test1<-indresp
test2<-indrespa
test3<-indrespb
=======
...
indresp<-read_dta(file=paste0(inpath, "ukhls/m_indresp.dta")) %>%
  select(pidp,m_indscui_lw) %>% full_join(indresp, by="pidp")
indresp$m_indscui_lw[indresp$m_indscui_lw<0]<-NA
indresp<-indresp[which(!is.na(indresp$m_indscui_lw)),]

indrespa<-read_dta(file=paste0(inpath, "ukhls/i_indresp.dta")) %>%

  select(pidp,i_indscui_lw) %>% full_join(indrespa, by="pidp")
indrespa$i_indscui_lw[indrespa$i_indscui_lw<0]<-NA
indrespa<-indrespa[which(!is.na(indrespa$i_indscui_lw)),]

indrespb<-read_dta(file=paste0(inpath, "ukhls/m_indresp.dta")) %>%
  select(pidp,m_indscui_lw) %>% full_join(indrespb, by="pidp")
indrespb$m_indscui_lw[indrespb$m_indscui_lw<0]<-NA
indrespb<-indrespb[which(!is.na(indrespb$m_indscui_lw)),]



#all the cases in which weighting==NA are removed

=======
  select(pidp,i_indscui_lw) %>% full_join(test1, by="pidp")
indrespa$i_indscui_lw[indrespa$i_indscui_lw<0]<-NA
indrespa<-indrespa[which(!is.na(indrespa$i_indscui_lw)),]

indresp$wavegroup<-c(0)
indresp$wavegroup[indresp$wave%in%c("wave 1",  "wave 2",  "wave 3",  "wave 4",  "wave 5",  "wave 6", "wave 7",  "wave 8","wave 9")]<-1
indresp$wavegroup[indresp$wave%in%c("wave 10",  "wave 11",  "wave 12",  "wave 13")]<-2
split_df <- split(indresp,indresp$wavegroup)
indrespb<-split_df$"2"

indrespa$wavegroup<-c(0)
indrespa$wavegroup[indrespa$wave%in%c("wave 1",  "wave 2",  "wave 3",  "wave 4",  "wave 5",  "wave 6", "wave 7",  "wave 8","wave 9")]<-1
indrespa$wavegroup[indrespa$wave%in%c("wave 10",  "wave 11",  "wave 12",  "wave 13")]<-2
split_df2 <- split(indrespa,indrespa$wavegroup)
indrespa<-split_df2$"1"


#do not include the cases lost completely at t+1
indresp<-indresp[which(indresp$separated%in%c(0,1,2)),]
indrespa<-indrespa[which(indrespa$separated%in%c(0,1,2)),]
indrespb<-indrespb[which(indrespb$separated%in%c(0,1,2)),]
```
...
rm(a_indrespp, b_indrespp, c_indrespp, d_indrespp, e_indrespp, f_indrespp, 
   h_indrespp, i_indrespp, j_indrespp, k_indrespp, l_indrespp, m_indrespp )
=======
#rm (a_egoalt, b_egoalt, c_egoalt, d_egoalt, e_egoalt, f_egoalt, g_egoalt, h_egoalt, i_egoalt, j_egoalt, k_egoalt, l_egoalt, m_egoalt, n_egoalt )
#rm(a_hhresp, b_hhresp, c_hhresp, d_hhresp, e_hhresp, f_hhresp, g_hhresp, h_hhresp, i_hhresp, j_hhresp, k_hhresp, l_hhresp, m_hhresp, n_hhresp)
#rm(a_hhsamp, b_hhsamp, c_hhsamp, d_hhsamp, e_hhsamp, f_hhsamp, g_hhsamp, h_hhsamp, i_hhsamp, j_hhsamp, k_hhsamp, l_hhsamp, m_hhsamp, n_hhsamp )
...
#education status
indrespa<-indrespa%>%mutate(student=case_when(jbstat==7~1,jbstat!=7~0))#full-time student
...
#wave jklm 
indresp$covid<-c(0)
indresp$covid[which(indresp$wave%in%c("wave 10","wave 11","wave 12","wave 13" ))]<-1
```
...
#education status
indresp<-indresp%>%mutate(student=case_when(jbstat==7~1,jbstat!=7~0))#full-time student #full-time student
...
#education status
indrespb<-indrespb%>%mutate(student=case_when(jbstat==7~1,jbstat!=7~0))#full-time student
...
indresp$race2<-c(0)
indresp$race2[indresp$racel_dv%in%c(1,2,3,4)]<-1

indresp$palnincomeXage<-indresp$palnincome*indrespb$age_centered
indresp$covidXage<-indresp$covid*indresp$age_centered
indresp$covidXrace<-indresp$covid*indresp$race2
indresp$covidXincome<-indresp$covid*indresp$lnincome
indresp$covidXedu<-indresp$covid*indresp$edu2
indresp$covidXpaincome<-indresp$covid*indresp$paincome
indresp$covidXpaedu<-indresp$covid*indresp$parent_edu2
indresp$covidXpalincomexage<-indresp$covid*indresp$palnincomeXage
indresp$covidXpahealth<-indresp$covid*indresp$parenthealth
...
#wave g leavers
gleave<-indrespa[which(indrespa$leave==1&indrespa$from_wave_g==1),]
#join with m indrespa for information
gleave<-join_all(list(gleave, h_indresp), by='pidp', type='left')
...
#wave h leavers
hleave<-indrespa[which(indrespa$leave==1&indrespa$from_wave_h==1),]
#join with i indrespa for information
hleave<-join_all(list(hleave,i_indresp), by='pidp', type='left')
...
#wave i leavers
ileave<-indrespa[which(indrespa$leave==1&indrespa$from_wave_i==1),]
#join with j indrespa for information
ileave<-join_all(list(ileave, j_indresp), by='pidp', type='left')
...
out<-rbind.fill(aleave,bleave,cleave,dleave,eleave,fleave,gleave,hleave,ileave)
out<-out%>%dplyr::select(pidp,wave,out)
...
#leaving for other reasons=0
out<-rbind.fill(jleave,kleave,lleave,mleave)
out<-out%>%dplyr::select(pidp,wave,out)
...
#student
indresp$studentleave<-c(0)
indresp$studentleave[indresp$out==3]<-1
...
#student
indrespa$studentleave<-c(0)
indrespa$studentleave[indrespa$out==3]<-1
...
#student
indrespb$studentleave<-c(0)
indrespb$studentleave[indrespb$out==3]<-1
...
##indresp
indresp$sep<-c(0)
indresp$sep[which(indresp$separated%in%c(1,2))]<-1

indresp<-indresp%>%mutate(boomrang=case_when(sep == 0 & lag(sep) == 1~1))
indresp$boomrang[is.na(indresp$boomrang)]<-0
...
svy_indresp <- svydesign(id=~psu, strata=~strata,
 weights=~m_indscui_lw, data=indresp)


svy_indrespa <- svydesign(id=~psu, strata=~strata,
 weights=~i_indscui_lw, data=indrespa)

svy_indrespb <- svydesign(id=~psu, strata=~strata,
 weights=~m_indscui_lw, data=indrespb)

indrespfy<-subset(svy_indresp, sex==1)
indrespmy<-subset(svy_indresp, sex==0)

indrespafy<-subset(svy_indrespa, sex==1)
indrespamy<-subset(svy_indrespa, sex==0)

indrespbfy<-subset(svy_indrespb, sex==1)
indrespbmy<-subset(svy_indrespb, sex==0)
```

```{r}
mar_f <- svyglm(mar~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)

mar_m <- svyglm(mar~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

cohab_f <- svyglm(cohab~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)

cohab_m <- svyglm(cohab~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

student_f <- svyglm(student~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)
student_m <- svyglm(student~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

all_f <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)
all_m <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)
```
...
```{r}
mar_a <- svyglm(mar~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespa)

cohab_a <- svyglm(cohab~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespa)

student_a <- svyglm(student~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespa)

all_af <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespafy)
all_am <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespamy)


all_a <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+sex+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespa)
```
...
```{r}
mar_b <- svyglm(mar~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespb)


cohab_b <- svyglm(cohab~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespb)


student_bf <- svyglm(student~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespb)

all_bf <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespbfy)
all_bm <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespbmy)


all_b <- svyglm(leave~palnincome+palnincomeXage+factor(parent_edu2)+factor(housing_tenure)+parenthealth+parentage+factor(liveboth)+age_centered+sex+lnincome+factor(edu2)+factor(family_status)+factor(racel2)+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = svy_indrespb)
```
...
```{r}
mar_f <- survey::svyglm(mar~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)

mar_m <- survey::svyglm(mar~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

cohab_f <- survey::svyglm(cohab~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)

cohab_m <- survey::svyglm(cohab~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

student_f <- survey::svyglm(student~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)
student_m <- survey::svyglm(student~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

all_f <- survey::svyglm(leave~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)
all_m <- survey::svyglm(leave~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)

boom_f<-survey::svyglm(boomrang~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespfy)
boom_m<-survey::svyglm(boomrang~palnincome+covidXpaincome+palnincomeXage+covidXpalincomexage+factor(parent_edu2)+covidXpaedu+factor(housing_tenure)+parenthealth+covidXpahealth+parentage+factor(liveboth)+age_centered+covidXage+lnincome+covidXincome+factor(edu2)+covidXedu+factor(family_status)+factor(racel2)+covidXrace+factor(student)+factor(unemployed)+factor(urban)+factor(houseprices)+factor(large_hh)+factor(wave),
                    family = quasibinomial(),
                    design = indrespmy)
...
convertModel <- function(model) {
  tr <- createTexreg(
    coef.names = names(summary(model)$coefficients[,1]), 
...
p1<-huxtablereg(lapply(list(all_af,all_bf), convertModel))
p2<-huxtablereg(lapply(list(all_am,all_bm), convertModel))
p3<-huxtablereg(lapply(list(cohab_a,cohab_b), convertModel))
p4<-huxtablereg(lapply(list(mar_a,mar_b), convertModel))
p5<-huxtablereg(lapply(list(all_a,all_b), convertModel))
=======
p1<-huxtablereg(lapply(list(cohab_f,cohab_m), convertModel))
p2<-huxtablereg(lapply(list(mar_f,mar_m), convertModel))
p3<-huxtablereg(lapply(list(student_f,student_m), convertModel))
p4<-huxtablereg(lapply(list(boom_f,boom_m), convertModel))
